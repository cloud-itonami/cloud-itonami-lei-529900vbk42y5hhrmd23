...
This repository archives the publicly published Terms and Conditions of
BlackRock, Inc., per ADR-2607110300 -- a read-only reference archive. As
...
- **Company**: BlackRock, Inc., LEI 529900VBK42Y5HHRMD23, website
  `https://www.blackrock.com`.
- **Baseline provenance** (real, from this repo's own `80-data/public/
  tos.journal.edn`): source-url `https://www.blackrock.com/corporate/
  compliance/terms-and-conditions`, retrieved-at `2026-07-10`, doc-type
  `:terms-of-service`.
